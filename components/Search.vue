<template>
    ...
    <div class="py-8">
        ...
        <p class="font-bold text-sm mb-1">Buscador de productos, hay 200, ej.: Producto 123 (hay algunos productos que tienen "styx river" en el nombre) prueba a buscar esos</p>
